...
<html>
<head>
<title id="title">Learning webGL &mdash; tutorial07</title>
...
<body onload="webGLStart07();" style="overflow: auto; overflow-x: hidden;">
<p id="breadcrumbs">
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="WebGLTutorials">WebGLTutorials</a> -&gt; WebGLTutorial07
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="WebGLTutorial08"> forward to Tutorial08 (will error, not yet written) </a>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="WebGLTutorial06"> backward to Tutorial06 </a>

</p>
<p id="header">
Tutorial07 &nbsp; Textures
</p>
<canvas id="tutorial07-canvas0" tabindex="0" width="500" height="500" style="border:none; position:absolute; left: 40px; top:50px;"></canvas>
<canvas id="tutorial07-canvas1" tabindex="1" width="500" height="500" style="border:none; position:absolute; left:552px; top:50px;"></canvas>
<div id="loadingtext">Loading world...</div>
<div id="tutorial07Tabs" style="position:relative; top:481px;"> 
	<ul>
		<li><a href="#idTab070">Textures</a></li>  
		<li><a href="#idTab071">ViewPoint Movement</a></li> 
		<li><a href="#idTab072">Directional Light</a></li>
		<li><a href="#idTab073">Point Light</a></li>
		<li><a href="#idTab074">Rotation Speed</a></li>
	</ul>
	<div id="idTab070">
	...
	<div id="idTab071" style ="height:350px;">
		<div style="position:relative; top:-10px; left:-10px;">
			<div id="xyzpry0" class="xyzpry" style="position:relative; left: 40px;">xyz=( ###.###, ###.###, ###.###) pry=(###.###,###.###,###.###)</div>
			<input type="button" id="home07-00"  style="position:relative; left: 0px; top:3px;" value="home North" ></input>
			<input type="button" id="home07-01"  style="position:relative; left: 0px; top:3px;" value="home" ></input>
			<input type="button" id="step07_up0" style="position:relative; left:40px; top:3px;" value="step up" ></input>
			<input type="button" id="step07_dn0" style="position:relative; left:40px; top:3px;" value="step dn" ></input>
			<input type="button" id="turn07_up0" style="position:relative; left:40px; top:3px;" value="turn up" ></input>
			<input type="button" id="turn07_dn0" style="position:relative; left:40px; top:3px;" value="turn dn" ></input>
		...
		<div style="position:relative; left:530px; top:-66px">
			...
			<input type="button" id="home07_10"  style="position:relative; left: 0px; top:3px;" value="home North" ></input>
	 		<input type="button" id="home07_11"  style="position:relative; left: 0px; top:3px;" value="home" ></input>
			<input type="button" id="step07_up1" style="position:relative; left:40px; top:3px;" value="step up" ></input>
			<input type="button" id="step07_dn1" style="position:relative; left:40px; top:3px;" value="step dn" ></input>
			<input type="button" id="turn07_up1" style="position:relative; left:40px; top:3px;" value="turn up" ></input>
			<input type="button" id="turn07_dn1" style="position:relative; left:40px; top:3px;" value="turn dn" ></input>
	...
	<div id="idTab072" style ="height:100px;" >
	...
	<div id="idTab073" style ="height:100px;" >
		<div style="position:relative; top:-10px">
	...
	<div id="idTab074" style ="height:100px;" >

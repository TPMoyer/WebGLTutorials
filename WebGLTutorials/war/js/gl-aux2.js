...
function initGL(canvas) {
	...
	try {
		...
		if(1==gl.length){
			...
			gl.fontXs  = [];
			gl.fontYs  = [];
			gl.fontXls = []; /* each character left edge of texture */
			gl.fontXrs = []; /* each character right edge of texture */
			gl.fontYls = []; /* each character bottom of texture */
			gl.fontYus = []; /* each character top of textexture */
			gl.font2Use=0;
			gl.fontIndex=0;

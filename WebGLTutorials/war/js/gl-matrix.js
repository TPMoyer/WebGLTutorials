...
(function (root, factory) {
    ...
    mat4.rotateX = function (mat, angle, dest) {
        var s = Math.sin(angle),
            ...
            a22 = mat[10],
            a23 = mat[11];
     	//AL(sprintf("mat[6]=%d angle=%8.3f sin=%6.3f cos=%6.3f",mat[6],angle,s,c));
        if (!dest) {
        	//AL("!dist");
            dest = mat;
    ...
    /* var identityQuat4 = quat4.identity();  this local variable is never used */
    ...
    quat4.inverse = function(quat, dest) {
        ...
        // TO DO: Would be faster to return [0,0,0,0] immediately if dot == 0

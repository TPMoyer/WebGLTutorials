...
<p id="header">
Tutorial06 &nbsp; Tweening Shapes and Materials
</p>
<canvas id="tutorial06-canvas0" tabindex="0" width="500" height="500" style="border:none; position:absolute; left: 40px; top:50px;"></canvas>
<canvas id="tutorial06-canvas1" tabindex="1" width="500" height="500" style="border:none; position:absolute; left:552px; top:50px;"></canvas>

<div id="tutorial06Tabs" style="position:relative; top:481px;"> 
	<ul> 

...
public class WebGLTutorial03Servlet  extends HttpServlet {
    private static final String primaryOutputJSP = "/webGLTutorial03.jsp";
    private static transient Logger logger = Logger.getLogger(WebGLTutorial03Servlet.class);
    ...
    throws ServletException, IOException {
        ...
        //logger.info("\ncme@ webGLTutorial03Servlet.java doPost");
		...
		if(false==ajaxLogging){
	         ...
	         * <div> elements.
	         *   Putting the cullface processingin java was done in order to demo how html can be sourced within java.
	         */
	        result_html.append(wgls.GetWebGLTutorial03(cullFace)); /* would call a function in the serrice, but am not adding anything myself */

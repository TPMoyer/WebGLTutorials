...
public class WebGLTutorial08Servlet  extends HttpServlet {
    private static final String primaryOutputJSP = "/webGLTutorial08.jsp";
    private static transient Logger logger = Logger.getLogger(WebGLTutorial08Servlet.class);
    ...
    throws ServletException, IOException {
        ...
        //logger.info("\ncme@ webGLTutorial08Servlet.java doPost");
		...
		if(false==ajaxLogging){
	         ...
	         */
	        result_html.append(wgls.GetWebGLTutorial08(cullFace)); /* would call a function in the serrice, but am not adding anything myself */

...
public class WebGLTutorial02Servlet  extends HttpServlet {
    private static final String primaryOutputJSP = "/webGLTutorial02.jsp";
    private static transient Logger logger = Logger.getLogger(WebGLTutorial02Servlet.class);
    ...
    throws ServletException, IOException {
        ...
        //logger.info("\ncme@ WebGLTutorial02Servlet.java doPost");
		...
		if(false==ajaxLogging){
	         ...
	         */
	        result_html.append(wgls.GetWebGLTutorial02(cullFace)); /* would call a function in the serrice, but am not adding anything myself */
	        //logger.debug("as recieved: result_html=\n"+result_html);
	//      req.setAttribute("form_html",form_html); /* Used the servlet, service model, but did not use a form for this app */

...
public class WebGLTutorial05Servlet  extends HttpServlet {
    private static final String primaryOutputJSP = "/webGLTutorial05.jsp";
    private static transient Logger logger = Logger.getLogger(WebGLTutorial05Servlet.class);
    ...
    throws ServletException, IOException {
        ...
        //logger.info("\ncme@ webGLTutorial05Servlet.java doPost");
		...
		if(false==ajaxLogging){
	         ...
	         */
	        result_html.append(wgls.GetWebGLTutorial05(cullFace)); /* would call a function in the serrice, but am not adding anything myself */

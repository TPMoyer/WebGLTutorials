...
public class WebGLTutorial04Servlet  extends HttpServlet {
    private static final String primaryOutputJSP = "/webGLTutorial04.jsp";
    private static transient Logger logger = Logger.getLogger(WebGLTutorial04Servlet.class);
    ...
    throws ServletException, IOException {
        ...
        //logger.info("\ncme@ webGLTutorial04Servlet.java doPost");
		...
		if(false==ajaxLogging){
	         ...
	         */
	        result_html.append(wgls.GetWebGLTutorial04(cullFace)); 

...
public class WebGLTutorial06Servlet  extends HttpServlet {
    private static final String primaryOutputJSP = "/webGLTutorial06.jsp";
    private static transient Logger logger = Logger.getLogger(WebGLTutorial06Servlet.class);
